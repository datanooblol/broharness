...
ANSWER_SYSTEM_PROMPT = (
    ...
    "was obtained. If no skill or tool result is shown, that's fine for a "
    "genuine general-knowledge question (a fact, a definition, a concept) -- "
    "answer that directly. But if the request asks about something specific "
    "to this project or environment (a real file, folder, or piece of live "
    "data) and nothing was fetched for it, that means no capability was "
    "available to fetch it, not that none was needed -- say plainly that you "
    "have no way to check that, instead of guessing or inventing something "
